...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 589, 414))
        ...
        self.gridLayout.addWidget(self.btnEscolherArquivo, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnRedimensionar, 5, 6, 1, 1)
        self.btnSalvar = QtWidgets.QPushButton(self.centralwidget)
        self.btnSalvar.setObjectName("btnSalvar")
        self.gridLayout.addWidget(self.btnSalvar, 6, 6, 1, 1)
