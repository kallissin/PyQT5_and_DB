...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora do Kelvin')
        self.setFixedSize(400, 400)
        self.cw = QWidget()
        self.grid = QGridLayout(self.cw)

        self.display = QLineEdit()  # Para adicionar o display
        self.grid.addWidget(self.display, 0, 0, 1, 5)  # grid é layout (existe outros)
...
if __name__ == "__main__":
    ...
    calc = Calculadora()
    calc.show()
    qt.exec_()  # Iniciar a calculadora
